            ...
            <div class="card text-white bg-dark mb-3">
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col">
                            <a href="{{route('app.courierD')}}" class="btn btn-danger">BACK</a>
                        </div>
                    </div>
                </div>

                <div class="card-body">
                    <form action="{{route('app.update_D')}}" method="POST">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            <label for="date" class="col-form-label">Date d'envoi</label>
                            <input type="date" class="form-control"name="date" id="date" value="{{$couriers->date_env}}"
                                placeholder="Date envoi">
                        </div>

                        <div class="form-group mb-3">
                            <label for="Destinataire" class="col-form-label">Destinataire</label>
                            <input type="text" class="form-control" name="Destinataire" id="Destinataire" value="{{$couriers->destinataire}}"
                        ...
                        <div class="form-group mb-3">
                            <label for="Frais" class="col-form-label">Frais</label>

                            <input type="number" class="form-control" name="Frais" id="Frais" value="{{$couriers->frais}}"
                                placeholder="Frais">
