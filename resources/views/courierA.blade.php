...
@section('title', 'Bureau d\'ordre |courier d\'arrivé')
...
@endif
    ...
    <div class="card mt-5 border border-info w-100">
                    ...
                    <div class="modal" id="myModal">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <!-- Modal body -->
                                <form action="{{ route('app.add_A') }}" method="post">
                                  @csrf
                                <div class="modal-body">
                                        <div class="form-group row">
                                            <label for="date" class="col-sm-3 col-form-label">Date d'arrivée</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group row">
                                            <label for="Expéditeur" class="col-sm-3 col-form-label">Expéditeur</label>
                                            <div class="col-sm-9">
                                                <input type="text" name="Expéditeur" class="form-control" id="Expéditeur"
                                        ...
                                        <div class="form-group row">
                                            <label for="Date d'expédition" class="col-sm-3 col-form-label">Date
                                                d'expédition</label>
                                            <div class="col-sm-9">
                                                <input type="date" name="date_exp" class="form-control" id="Date d'expédition"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="Réfèrence" class="form-control" id="Réfèrence"
        ...
        <div class="card-body">
            <form action="{{ route('app.search_A') }}" method="post" class="form-inline d-flex justify-content-center">
                @csrf
                @method('get')
                <div class="form-group">
                    <input type="text" name="search" placeholder="Entrer Numero OU objet OU Expéditeur OU Reference OU Date d'arrivée OU Date d'expidition"
                ...
                <table class="table table-bordered mt-5">
                    ...
                    @forelse($data as $d)
                        <tr>
                            ...
                            <td>{{ $d->observation }}</td>
                            <td>
                                <a href="{{ route('app.edit_A',$d->numero) }}" class="btn btn-success">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                <a href="{{route('app.delete_A',$d->numero)}}" class="btn btn-danger">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
